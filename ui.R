...
shinyUI(   fluidPage(
  ...
  mainPanel(
    ...
    wellPanel(
      h4("Details"),
      HTML("<p> Github Repository <a href='https://github.com/Laxmi530/Capstone_project' target='_blank'>https://github.com/Laxmi530/Capstone_project</a></p>"),
      HTML("<p> Slide Deck Presentation  <a href='https://rpubs.com/laxmi530/capstone_project_slide' target='_blank'>https://rpubs.com/laxmi530/capstone_project_slide</a></p>"),
      h4("Author:"),
      p("Laxmidhar Routa")
    )
